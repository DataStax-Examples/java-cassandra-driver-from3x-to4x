 ...
 */
public class SampleCode3x_CONNECT_CreateKeyspace implements ExampleSchema {
    
    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(SampleCode3x_CONNECT_CreateKeyspace.class);
